...
namespace QandAService
{
    public static class QandAService
    {
        ...
        static string host = "https://qnatriallalita.azurewebsites.net/qnamaker";
        ...
        static string key = Utility.Subscription.QandAKey;

        // NOTE: The KB ID is found in GetStatus() call
        static string kbid = Utility.Subscription.kbID;

        // NOTE: The endpoint key is found in GetEndpointKeys() call
        static string endpoint_key = Utility.Subscription.EndPointKey;

        // NOTE: The host name is found in GetKnowledgeBaseHostNameDetails() call
        static string endpoint_host = "https://qnatriallalita.azurewebsites.net";
...
";
        ...
        public async static Task CreateKB()
        {
            try
            {
                // Builds the HTTP request URI.
        ...
        //      Get endpoint
        public async static Task PublishKB()
        {
            string responseText;
        ...
        public async static Task GetKnowledgeBaseHostNameDetails()
        {
            var uri = host + service + baseRoute + "/" + kbid;
        ...
        public async static Task GetEndpointKeys()
        {
